...
donor_cells_abs_corr <- cor(donor_cells_abs, method = "pearson", use = "pairwise.complete.obs")

corrplot(donor_cells_abs_corr, method = 'number')

donor_cells_perc_corr <- cor(donor_cells_perc, method = "pearson", use = "pairwise.complete.obs")
donor_cells_perc_corr
...
donor_cells_abs_scaled <- scale(donor_cells_abs) #Стандартизируем значения
...
donor_cells_perc_scaled <- scale(donor_cells_perc) #Стандартизируем значения
