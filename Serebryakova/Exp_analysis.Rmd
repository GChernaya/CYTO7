...
#Перевели 10^9 в 10^7
dd <- dd %>% 
  mutate(across(matches("cd"), ~ .x * 100))
dd$ly = 100*dd$ly
...
forest_model(model_list = univ_models,covariates = covariates,merge_models =T, format_options = forest_model_format_options(text_size = 2))
...
ggsave(filename = "plot3.png",width = 8, height = 4, dpi = 1000)
```
